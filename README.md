...
[![Build Querqy](https://github.com/querqy/querqy-solr/actions/workflows/ci.yml/badge.svg)](https://github.com/querqy/querqy-solr/actions/workflows/ci.yml)
[![Docker Integration Tests for Querqy](https://github.com/querqy/querqy-solr/actions/workflows/integration-tests.yml/badge.svg)](https://github.com/querqy/querqy-solr/actions/workflows/integration-tests.yml)
[![Querqy for Solr](https://img.shields.io/maven-central/v/org.querqy/querqy-solr.svg?label=Download%20Querqy%20for%20Solr%20(Maven%20Central))](https://repo1.maven.org/maven2/org/querqy/querqy-solr/) 
...
This is the repository `querqy-solr`. Repositories for further Querqy integrations can be found at:
...
Querqy for Solr sits on top of `querqy-core` and `querqy-lucene`. Their repository can be found at:

* https://github.com/querqy/querqy/ (Querqy Core and Querqy Lucene)
